...
internal class Program
{
    ...
    public static bool CompileWithSeed(int seed, string coreRootPath, string compilationInputFolder, string outDir)
    {
        ...
        ProcessStartInfo processStartInfo = new ProcessStartInfo(coreRunPath, $"{superIlcPath} compile-directory -cr {coreRootPath} -in {compilationInputFolder} -ct 15 -et 15 --nojit --noexe --large-bubble --release --nocleanup -out {outDir}");
