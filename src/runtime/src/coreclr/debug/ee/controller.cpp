...
void DebuggerController::ApplyTraceFlag(Thread *thread)
{
    ...
    SetSSFlag(reinterpret_cast<DT_CONTEXT *>(context) ARM_ARG(thread) ARM64_ARG(thread) LOONGARCH64_ARG(thread));
}
...
void DebuggerController::UnapplyTraceFlag(Thread *thread)
{
    ...
    UnsetSSFlag(reinterpret_cast<DT_CONTEXT *>(context) ARM_ARG(thread) ARM64_ARG(thread) LOONGARCH64_ARG(thread));
}
